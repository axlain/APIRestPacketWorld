...
public class Constantes {
    ...
    public static final String MSJ_EXITO_REGISTRO = "Se registró correctamente la ";
    public static final String MSJ_EXITO_ACTUALIZAR = "Se actualizó correctamente la ";
    public static final String MSJ_EXITO_BAJA = "Se dio de baja correctamente la ";
